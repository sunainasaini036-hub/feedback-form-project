...
def get_responses(form_id):
    ...
    for row in rows:
        ...
        responses.append(
            {"answers": json.loads(row["answers"]), "submitted_at": row["submitted_at"]}
        )
...
def update_form_db(form_id, form):
    ...
    """,
        (form["title"], form["description"], json.dumps(form["questions"]), form_id),
    )
    ...
    for response in responses:
        ...
        for question, answer in answers.items():
            ...
            if isinstance(answer, list):
                ...
                statistics[question][answer] = statistics[question].get(answer, 0) + 1
    ...
    for response in responses:
        ...
        for value in answers.values():
            ...
            if value:
                ...
                if value and value.lower() not in ["select rating", "none", "null"]:
